                ...
                if (typeElem.isPresent()) {
                    ...
                    if (valueField.isPresent()) {
                        ...
                        try {
                            ...
                            File sourceFile = new File(fileObject.toUri());
                    ...
                    jsonObjectTemplate
                        ...
                        .forEach(jsonSubTypeElementWithEnum -> {
                            if (!jsonSubTypeElementWithEnum.value().toString().equals(currentElement.asType().toString())) {
                                //enumValue, property, setter and value
                                ...
                                // Remove the current element to avoid infinite loop
                                var jsonTypeClassFiltered = jsonTypeClass
                                    .entrySet()
                                    .stream()
                                    .filter(entry -> entry.getKey() != currentElement)
                                ...
                                generateEvalMethods(
                                    ...
                                    jsonTypeClass, //jsonTypeClassFiltered,

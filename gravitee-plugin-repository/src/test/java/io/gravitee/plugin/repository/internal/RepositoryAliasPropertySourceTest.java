...
public class RepositoryAliasPropertySourceTest {
    ...
    public void should_prefer_new_prefix_when_both_are_set() {
        ...
        props.put("management.mongodb.uri", "mongodb://oldhost:27017/gravitee");
        props.put("repositories.management.mongodb.uri", "mongodb://newhost:27017/gravitee");
        setProperties(props);
    ...
    public void should_resolve_multiple_elasticsearch_endpoints_from_new_prefix() {
        Map<String, Object> props = new HashMap<>();
        props.put("repositories.analytics.elasticsearch.endpoints[0]", "http://es1:9200");
        props.put("repositories.analytics.elasticsearch.endpoints[1]", "http://es2:9200");
        setProperties(props);
